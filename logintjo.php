...
<form class="regga col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4"  style="margin-top: 70px;" action='login.php' method='POST'>
						     <fieldset><h2>log in</h2></fieldset>

						<input class="col-xs-12 col-md-10 col-md-offset-1"  type='text' name='uid' placeholder='username'>
						<input class="col-xs-12 col-md-10 col-md-offset-1"  type='password' name='pwd' placeholder='password'><br>
						<button class="button col-xs-6 col-xs-offset-3" type="submit">log in </button>
					</form>
